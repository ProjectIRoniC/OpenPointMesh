...
SET( PSLINK_CXX_FLAGS "${EP_NONCMAKE_COMMON_CXX_FLAGS} -I${LIBUSB_1_INCLUDE_DIR} -I${PSLINK_SOURCE_DIR} -I${XNLIB_INCLUDE_DIR} -I${OPENNI2_LIB_INCLUDE_DIR} -I${XNLINK_PROTOCOL_DIR} -I${LINK_PROTOCOL_DIR}" )
SET( PSLINK_LD_FLAGS "${CMAKE_EXE_LINKER_CXX_FLAGS} -L${LIBUSB_1_LIBRARY_DIR} -l${LIBUSB_1_LIBRARY_NAME} -L${XNLIB_BIN_DIR} -l${XNLIB_LIBRARY_NAME} -L${OPENNI2_LIB_BIN_DIR}" )
